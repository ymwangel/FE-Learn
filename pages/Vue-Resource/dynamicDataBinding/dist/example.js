...
/***/ (function(module, exports, __webpack_require__) {
	...
	Bue.prototype = (0, _extends3.default)({
	    constructor: Bue
	}, __webpack_require__(41), __webpack_require__(42), __webpack_require__(66), __webpack_require__(67), __webpack_require__(68), {
	    observer: (0, _extends3.default)({}, __webpack_require__(69))
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _directive = __webpack_require__(65);
	...
	exports._compileElement = function (node) {
	    if (node.hasChildNodes()) {
	        (0, _from2.default)(node.childNodes).forEach(this._compileNode, this);
	    }
	};
	...
	exports._compileText = function (node) {
	    ...
	    expressions.forEach(function (expression) {
	        ...
	        _this._bindDirective('text', property, el);
	    });
	...
	exports._bindDirective = function (name, expression, node) {
	    ...
	    dirs.push(new _directive2.default(name, node, this, expression));
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(12)(IteratorPrototype, __webpack_require__(56)('iterator'), function () { return this; });
...
/***/ (function(module, exports) {
	...
	exports.$watch = function (key, fn) {
	    ...
	    if (pathAry.length === 1) {
	        ...
	        var _temp = this.$data;
	        var lastProperty = pathAry.pop();

	        pathAry.forEach(function (property) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _arrayAugmentations = __webpack_require__(94);

	var _arrayAugmentations2 = _interopRequireDefault(_arrayAugmentations);

	var _objectAugmentations = __webpack_require__(95);
	...
	function Observer(value, type) {
	    ...
	    if (type === ARRAY) {
	        value.__proto__ = _arrayAugmentations2.default; // eslint-disable-line
	        this.link(value);
	    } else if (type === OBJECT) {
	        value.__proto__ = _objectAugmentations2.default; // eslint-disable-line
	        this.walk(value);
	    }
	}
	...
	Observer.prototype.convert = function (key, val) {
	    var ob = this;
	    (0, _defineProperty2.default)(this.value, key, {
	        enumerable: true,
	        configurable: true,
	        get: function get() {
	            return val;
	...
	Observer.prototype.off = function (event, fn) {
	    ...
	    // 取消特定事件的特定回调函数
	    for (var i = 0, cb; i < callbacks.length; i++) {
	        cb = callbacks[i];
	        if (cb === fn) {
	...
	Observer.prototype.emit = function (event, path, val) {
	    ...
	    callbacks.forEach(function (cb, i) {
	        callbacks[i].apply(_this2, _arguments);
	    });
	};
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	_util2.default.define(objectAgumentations, '$add', function (key, val) {
	    if (this.hasOwnProperty(key)) return;
	    _util2.default.define(this, key, val, true);
	    var ob = this.$observer;
	    ob.observe(key, val);
	    ob.convert(key, val);
	});

	_util2.default.define(objectAgumentations, '$delete', function (key) {
	    if (!this.hasOwnProperty(key)) return;
	    delete this[key];
	});
